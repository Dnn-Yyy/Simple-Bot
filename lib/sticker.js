...
async function sticker3(img, url, packname, author, categories = [], extra = {}) {
	...
	const stickerMetadata = {
		type: 'full',
		pack: packname,
		author: author,  // Corrected this line
		categories,
		...extra
	}
...
async function addExif(webpSticker, packname, author, categories = [], extra = {}) {
	...
	const json = { 'sticker-pack-id': stickerPackId, 'sticker-pack-name': packname, 'sticker-pack-publisher': author, 'emojis': categories, 'powered-by': 'Victoria Rosalind', 'Youtube': 'https://youtube.com/@ClayzaAubert', ...extra };
